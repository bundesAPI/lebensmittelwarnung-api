...
import urllib3
from deutschland.lebensmittelwarnung.exceptions import ApiValueError
...
class Configuration(object):
    ...
    conf = lebensmittelwarnung.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "https://megov.bayern.de/verbraucherschutz/baystmuv-verbraucherinfo/rest/api"
            if host is None
            else host
        )
        """Default Base url
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("lebensmittelwarnung")
