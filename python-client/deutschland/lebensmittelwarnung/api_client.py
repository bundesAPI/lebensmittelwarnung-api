...
from deutschland.lebensmittelwarnung import rest
...
from deutschland.lebensmittelwarnung.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.list_warnungen  # this is an instance of the class Endpoint
        api_instance.list_warnungen()  # this invokes api_instance.list_warnungen.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_warnungen.callable or self.callable in this class
