...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_warnungen_endpoint = _Endpoint(
            settings={
                "response_type": (Response,),
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/warnings/merged",
                "operation_id": "list_warnungen",
                "http_method": "POST",
                "servers": None,
            },
            params_map={
    ...
    def list_warnungen(self, **kwargs):
        """Liste aller Lebensmittel und Produktwarnungen  # noqa: E501

        Gibt eine Liste aller Lebensmittel und Produktwarnungen zurück.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_warnungen(async_req=True)
        >>> result = thread.get()
